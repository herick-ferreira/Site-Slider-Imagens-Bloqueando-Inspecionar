...
const showAlert = e => {
    e.preventDefault();
    return alert("Desculpe, mas você não pode copiar o código da página desta forma...");
}
...
const createDownloadBtn = () => {
    ...
    downloadBtn.innerHTML = `<a href="${downloadPostLink}" target="_blank">Download do Código e Arquivos</a>`;
